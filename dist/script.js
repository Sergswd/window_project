...
var changeWindowState = function changeWindowState(state) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeWindowState);
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = 'hidden'; // document.body.classList.add('open-modal');
      });
    });
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ''; // document.body.classList.remove('open-modal');  
    });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 6000000);
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    var i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3;
